...
import OceanHeroFallback from '@/components/ocean3d/OceanHeroFallback';

const OceanHero3D = dynamic(() => import('@/components/ocean3d/OceanHero3D'), {
  ssr: false,
  loading: () => <OceanHeroFallback/>,
});
...
export default function HomePage(){
  return <main>
    <section className="relative min-h-screen overflow-hidden bg-ocean-950">
      <div className="absolute inset-0"><OceanHero3D/></div>
