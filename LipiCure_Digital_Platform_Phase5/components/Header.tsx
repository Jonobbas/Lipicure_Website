...
export default function Header() {
  ...
  const links = [
    ['Technology','/technology'], ['PEARL-X','/pearl-x'], ['Platform','/marine-bioprocess-intelligence'], ['Research','/research'], ['Knowledge Hub','/knowledge'], ['Collaboration','/collaboration'], ['Founder','/founder-story'], ['About','/about']
  ];
  return (
